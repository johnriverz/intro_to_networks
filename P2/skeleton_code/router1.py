...
def main():
    ...
    for packet in packets_table:
        ...
        # 10. Find the appropriate sending port to forward this new packet to.
        dst_port = find_sending_port(destinationIP_int, forwarding_table_with_range)

        # 11. If no port is found, then set the sending port to the default port.
        if dst_port is None:
